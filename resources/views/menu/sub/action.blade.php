...
{{--Edit Component--}}
@can('menu.edit')
    <b-modal v-cloak id="modalmenuedit{{ $menu->id }}" title="{{ trans('alpaca::alpaca.edit') }}" hide-footer>
...
{{--Delete Component--}}
@can('menu.delete')
    <b-modal v-cloak id="modalmenudelete{{ $menu->id }}" title="{{ trans('alpaca::alpaca.sure_delete') }}" hide-footer>
